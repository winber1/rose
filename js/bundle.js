...
/***/ function(module, exports, __webpack_require__) {
	...
	var _video_detail = __webpack_require__(177);

	var _video_detail2 = _interopRequireDefault(_video_detail);

	var _video_playlist = __webpack_require__(178);
	...
	var App = function (_Component) {
	  ...
	  function App(props) {
	    ...
	    (0, _youtubeApiSearch2.default)({ key: API_KEY,
	      ...
	      type: 'video' }, function (videos) {
	      // console.log(videos);
	      _this.setState({ videos: videos }); // same as { videos: videos }
	    });

	    // playList search
	    (0, _youtubeApiSearch2.default)({ key: API_KEY,
	      channelId: 'UCghGuUjJUeuGkCYauHHwGCA',
	      type: 'playlist' }, function (playlists) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_video_playlist2.default, { playlists: this.state.playlists })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VideoPlayList = function VideoPlayList(props) {
	  console.log('in videoPlayList');
	  var playlistItems = props.playlists.map(function (playlist) {
	    //return <VideoListItem key={video.etag} video={video} />

	    var title = playlist.snippet.title;
	    var imgURL = playlist.snippet.thumbnails.default.url;
	    return _react2.default.createElement(
	      'div',
	      null,
	      _react2.default.createElement(
