...
/***/ function(module, exports, __webpack_require__) {
	...
	var _search_bar = __webpack_require__(174);

	var _search_bar2 = _interopRequireDefault(_search_bar);

	var _video_list = __webpack_require__(175);

	var _video_list2 = _interopRequireDefault(_video_list);

	var _video_detail = __webpack_require__(195);

	var _video_detail2 = _interopRequireDefault(_video_detail);

	var _video_playlist = __webpack_require__(196);

	var _video_playlist2 = _interopRequireDefault(_video_playlist);
	...
	var API_KEY = 'AIzaSyCpFFn5L-9JfU9-hOJpXPzCtWhE9AXhOAw';
	var YTchannelID = 'UCghGuUjJUeuGkCYauHHwGCA'; //roseastrology
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function getVideos() {
	      ...
	      this.myYTSearch('search', params, function (videos) {
	    ...
	    value: function getPlaylists() {
	      ...
	      this.myYTSearch('search', params, function (playlists) {
	        ...
	        playlists.forEach(function (playlist, index) {
	          ...
	          _this3.myYTSearch('playlistItems', params, function (videos) {
	            ...
	            if (count === 12) {
	              ...
	              _this3.setState({ playListObjs: playListObjs });
	            }
	          });
	        });
	      });
	    ...
	    key: 'myYTSearch',
	    value: function myYTSearch(path, params, callback) {
	      var p = ROOT_URL + path;
	      _axios2.default.get(p, { params: params }).then(function (response) {
	        if (callback) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_video_playlist2.default, { playlists: this.state.playListObjs })
	      );
	    }
	  }]);
	...
	_reactDom2.default.render(_react2.default.createElement(App, null), document.querySelector('.VideoListContainer'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _video_list_item = __webpack_require__(176);
	...
	var VideoList = function (_React$Component) {
	  ...
	  _createClass(VideoList, [{
	    key: 'getVideos',
	    value: function getVideos() {
	      // this works using state from index.js
	      var videoItems = this.props.videos.map(function (video) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VideoDetail = function VideoDetail(_ref) {
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: 'video-etail col-md-8' },
	    _react2.default.createElement(
	      'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VideoPlayList = function (_React$Component) {
	  _inherits(VideoPlayList, _React$Component);

	  function VideoPlayList(props) {
	    _classCallCheck(this, VideoPlayList);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(VideoPlayList).call(this, props));
	  }

	  _createClass(VideoPlayList, [{
	    key: 'getVideos',
	    value: function getVideos(vids) {
	      var videoItems = vids.map(function (video) {
	        return _react2.default.createElement(_video_list_item2.default, { key: video.etag, video: video });
	      });
	      return videoItems;
	    }
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'ul',
	          { className: 'col-md-4 list-group' },
	          this.props.playlists.map(function (pl) {
	            console.log(pl.etag);
	            return _react2.default.createElement(
	              'div',
	              { etag: pl.etag },
